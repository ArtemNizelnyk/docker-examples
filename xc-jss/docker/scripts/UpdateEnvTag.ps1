...
.PARAMETER use1909
A switch to choose whether to use the 1909 builds with inProcess isolation enabled
...
if (($use1909) -and ($jsonFile -match '2019')) {
    Throw 'Json config file does not match the O/S version chosen. You cannot -use1909 and configltsc2019.json together.'
}
